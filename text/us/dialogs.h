...
DEFINE_DIALOG(DIALOG_005, 1, 3, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_014, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_016, 1, 3, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_030, 1, 6, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_033, 1, 6, 50, 200, _("\
Ciao! You've reached\n\
...
DEFINE_DIALOG(DIALOG_039, 1, 4, 50, 200, _("\
No visitors allowed,\n\
by decree of\n\
the Big Bob-omb\n\
\n\
...
DEFINE_DIALOG(DIALOG_041, 1, 3, 50, 200, _("\
I win! You lose!\n\
Ha ha ha!\n\
\n\
...
DEFINE_DIALOG(DIALOG_054, 1, 5, 50, 200, _("\
Welcome to the snow\n\
...
DEFINE_DIALOG(DIALOG_055, 1, 4, 50, 200, _("\
Hey-ey, Mario, buddy,\n\
...
DEFINE_DIALOG(DIALOG_058, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_059, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_062, 1, 3, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_063, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_064, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_071, 1, 3, 50, 200, _("\
Danger Ahead!\n\
...
DEFINE_DIALOG(DIALOG_076, 1, 6, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_081, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_085, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_087, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_091, 2, 2, 50, 200, _("\
Danger!\n\
Strong Gusts!\n\
...
DEFINE_DIALOG(DIALOG_093, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_095, 1, 4, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_104, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_123, 1, 4, 50, 200, _("\
Metal Cavern\n\
Right: To Waterfall\n\
...
DEFINE_DIALOG(DIALOG_126, 2, 3, 50, 200, _("\
Up: Black Hole\n\
Right: Work Elevator\n\
/// Hazy Maze"))

DEFINE_DIALOG(DIALOG_127, 3, 4, 50, 200, _("\
Underground Lake\n\
Right: Metal Cave\n\
Left: Abandoned Mine\n\
///(Closed)\n\
...
DEFINE_DIALOG(DIALOG_132, 1, 4, 50, 200, _("\
Whoa, Mario, pal, you\n\
...
DEFINE_DIALOG(DIALOG_134, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_137, 1, 6, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_138, 1, 3, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_149, 1, 3, 50, 200, _("\
Welcome to\n\
Princess Toadstool's\n\
secret slide!\n\
...
DEFINE_DIALOG(DIALOG_152, 1, 3, 50, 200, _("\
Owwch! Uncle! Uncle!\n\
...
DEFINE_DIALOG(DIALOG_155, 1, 6, 50, 200, _("\
Thanks to the power of\n\
the Stars, life is\n\
returning to the castle.\n\
Please, Mario, you have\n\
...
DEFINE_DIALOG(DIALOG_156, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_159, 1, 6, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_165, 1, 5, 50, 200, _("\
...
DEFINE_DIALOG(DIALOG_168, 1, 5, 50, 200, _("\
