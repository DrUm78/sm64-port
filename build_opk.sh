...
if [ -e ./baserom.us.z64 ]; then
	make -j16 VERSION=us
	mksquashfs build/us_gcw0/sm64.us.f3dex2e opk/sm64.png opk/sm64_us."$1".desktop opk/menu_resources/ sm64_us_"$1".opk
fi
if [ -e ./baserom.jp.z64 ]; then
	make -j16 VERSION=jp
	mksquashfs build/jp_gcw0/sm64.jp.f3dex2e opk/sm64.png opk/sm64_jp."$1".desktop opk/menu_resources/ sm64_jp_"$1".opk
fi
